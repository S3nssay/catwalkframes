  ...
  const handleNaturalLanguageSearch = async (query: string) => {
    try {
      ...
      const response = await fetch('/api/search/natural-language', {
        ...
        body: JSON.stringify({ query, listingType: 'sale' })
      });
      ...
      <section ref={heroRef} className="relative min-h-[85vh] flex items-center justify-center overflow-hidden pb-16" style={{ backgroundColor: '#791E75' }}>
        ...
        <div className="relative z-10 text-center max-w-6xl mx-auto px-6">
          ...
          <div className="flex justify-center gap-4 mb-8">
            ...
            <Link href="/rentals">
              <Button className="bg-[#8B4A9C] hover:bg-[#7A4289] text-white px-6 py-3 rounded-xl">
          ...
          <div className="mt-6 max-w-5xl mx-auto">
            <NaturalLanguageSearch
              ...
              type="sales"
              placeholder="Tell our AI what you're looking for... e.g., 'Find me 3 bedroom flats in Harlesden under £800k'"
            />
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Handpicked exceptional properties representing the finest in London luxury living
            </p>
          </div>
      ...
      <section className="py-20 px-6 bg-slate-50">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center justify-between mb-12">
            <div>
              <h2 className="text-3xl md:text-4xl font-black mb-4 text-slate-800">ALL PROPERTIES FOR SALE</h2>
            ...
            <div className="flex items-center text-blue-600">
              ...
              <span className="font-medium">Market trending up 12%</span>
            </div>
          </div>
      ...
      <section className="py-20 px-6 bg-gradient-to-r from-slate-700 to-slate-800">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
            Get a free, no-obligation valuation from London's luxury property experts
          </p>
